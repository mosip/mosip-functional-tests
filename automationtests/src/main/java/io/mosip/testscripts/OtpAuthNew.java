...
public class OtpAuthNew extends AdminTestUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException {		
		...
		JSONObject sendOtpBody = new JSONObject(sendOtpReqResp.asString());
...
//		Response otpRespon = RestClient.postRequestWithHeder(ApplnURI + "/idauthentication/v1/otp/5hUMlbiYsUNfq1pWAmtjaffDc6g6MJiDjJ8tvH59HtIEY5IXRB/mosip-2324/467770", sendOtpBody.toString(), MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON,  "signature", signature);
		Response otpRespon = RestClient.postRequestWithMultipleHeadersWithoutCookie(ApplnURI + "/idauthentication/v1/otp/5hUMlbiYsUNfq1pWAmtjaffDc6g6MJiDjJ8tvH59HtIEY5IXRB/mosip-2324/467770", sendOtpBody,
