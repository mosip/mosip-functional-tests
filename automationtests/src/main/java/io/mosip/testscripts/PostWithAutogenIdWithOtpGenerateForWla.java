...
public class PostWithAutogenIdWithOtpGenerateForWla extends AdminTestUtil implements ITest {
	...
	public void test(TestCaseDTO testCaseDTO) throws AuthenticationTestException, AdminTestException {		
		...
		if(testCaseName.contains("ESignet_")) {
			String tempUrl = ApplnURI.replace("-internal", "");
			response = postWithBodyAndCookieAuthHeaderAndXsrfTokenForAutoGeneratedId(tempUrl + testCaseDTO.getEndPoint(), getJsonFromTemplate(req.toString(), testCaseDTO.getInputTemplate()), COOKIENAME, testCaseDTO.getRole(), testCaseDTO.getTestCaseName(), idKeyName);
		}
		else {
