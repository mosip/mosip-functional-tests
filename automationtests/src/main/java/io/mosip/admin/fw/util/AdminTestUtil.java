...
public class AdminTestUtil extends BaseTestCase{
	...
	//public static Properties IDlookupFile = getproperty(MosipTestRunner.getGlobalResourcePath() + "/"+"config/application.properties");
	...
	public static HashMap<String, String> tempFieldMap = new HashMap<>();
	public static String langcode;
	public static AdminTestUtil adminTestUtil = new AdminTestUtil();
	...
	protected Response postWithBodyAndCookieForAutoGeneratedId(String url, String jsonInput, String cookieName, String role, String testCaseName, String idKeyName) {
		Response response=null;
		String inputJson = inputJsonKeyWordHandeler(jsonInput, testCaseName);
		//String outputjson = inputJsonKeyWordHandeler(jsonOutput, testCaseName);
		token = kernelAuthLib.getTokenByRole(role);
		logger.info("******Post request Json to EndPointUrl: " + url + " *******");
		Reporter.log("<pre>" + ReportUtil.getTextAreaJsonMsgHtml(inputJson) + "</pre>");
		try {
	...
	String inputJsonKeyWordHandeler(String jsonString, String testCaseName)
	{
		...
		/*
		 * if(jsonString.contains("$LANGCODE$")) jsonString =
		 * jsonString.replace("$LANGCODE$", BaseTestCase.langcode);
		 */
