...
public class AdminTestUtil extends BaseTestCase{
	...
	public String generateIdentityJson(String testCaseName) {
		...
		if (!IdObj.isEmpty()) {
			...
			IdObj.replace("UIN", replaceIdWithAutogeneratedId(identityObect.toString(), "$ID:", autoGenIdFileName));
		}
		String body = Base64.getEncoder().encodeToString(actualrequest.toString().getBytes());
		return body;
	}
