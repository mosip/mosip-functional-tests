...
public class TestJava {
	...
	public static void main(String[] args) {
		...
		String message = "Dear FR OTP for VID XXXXXXXX65185914 is 111111 and is valid for 3 minutes. (Generated on 21-03-2023 at 16:03:54 Hrs)\r\n"
		...
		if(message2!=null) {
		    Matcher mMatcher = mPattern.matcher(message2);
		    if(mMatcher.find()) {
