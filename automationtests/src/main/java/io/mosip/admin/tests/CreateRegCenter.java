...
public class CreateRegCenter extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(CreateRegCenter.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, CreateRegCenter.testCaseName);
		} catch (Exception e) {
	...
	public void otpGenerationTest(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException {
		...
		logger.info("******Post request Json to EndPointUrl: " + RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getAdminCreateRegCentrePath()+
				 " *******");
