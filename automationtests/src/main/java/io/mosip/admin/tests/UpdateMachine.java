...
public class UpdateMachine extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(UpdateMachine.class);
	...
	public void setTestType() {
		...
		String query = queries.get("createMachine2EngUpdate").toString().replace("true", "false");
	...
	public void updateRegCenter(TestParameters objTestParameters, String testScenario, String testcaseName)
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl()
				+ RunConfigUtil.objRunConfig.getUpdateMachinePath();
	...
	public void cleanup() throws AdminTestException {
		...
		if (masterDB.executeQuery(queries.get("deleteMachine2EngUpdate").toString(), "masterdata"))
