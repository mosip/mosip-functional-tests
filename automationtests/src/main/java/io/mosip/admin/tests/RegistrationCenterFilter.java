...
public class RegistrationCenterFilter extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(RegistrationCenterFilter.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, RegistrationCenterFilter.testCaseName);
		} catch (Exception e) {
	...
	public void otpGenerationTest(TestParameters objTestParameters, String testScenario, String testcaseName)
		...
		String cookieValue = getAuthorizationCookie(getCookieRequestFilePathForUinGenerator(),
				"https://dev.mosip.io/v1/authmanager/authenticate/useridPwd", AUTHORIZATHION_COOKIENAME);
