...
public class RegistrationCenterSearch extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(RegistrationCenterSearch.class);
