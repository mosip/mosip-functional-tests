...
public class FilterBlackListedWords extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(FilterBlackListedWords.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, FilterBlackListedWords.testCaseName);
		} catch (Exception e) {
	...
	public void filterBlackListedWords(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getFilterBlackListedWordsPath();
