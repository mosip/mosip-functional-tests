...
public class FetchRegCenterWorkingDays_kernel  extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(FetchRegCenterWorkingDays_kernel.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(queries.get("createRegCenterWorkingNonWorkingDays").toString(), "masterdata")
				&& masterDB.executeQuery(queries.get("mapworkingDaysToRegCenter").toString(), "masterdata"))
			logger.info("created regCenter and workingdays mapping successfully using query from query.properties");
		else
			logger.info("not able to create regCenter and workingdays mapping successfully using query from query.properties");
	}
	...
	public void fetchRegCenterWorkingDays(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException, IOException, ParseException {
	...
	public void cleanup() throws AdminTestException {
		String query1 = queries.get("deleteRegCenterWorkingdaysMapping").toString();
