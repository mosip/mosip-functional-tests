...
public class CreateGender  extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		String query = queries.get("createGender").toString();
		if (masterDB.executeQuery(query, "masterdata"))
			logger.info("Gender created with new code as Test successfully using query from query.properties");
		else
			logger.info("not able to create Gender using query from query.properties");
	}
	...
	public void createGender(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getCreateGenderPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteGender").toString(), "masterdata"))
			logger.info("deleted all created gender details successfully");
		else {
			logger.info("not able to delete created gender details using query from query.properties");
			throw new AdminTestException("not able to delete created gender details data form DB");
		}
	}
}
