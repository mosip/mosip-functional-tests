...
public class CreateDocumentType extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		String query = queries.get("createDocumentType").toString().replace("true", "false");
	...
	public void createDocType(TestParameters objTestParameters, String testScenario, String testcaseName)
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl()
				+ RunConfigUtil.objRunConfig.getCreateDocumentTypePath();
