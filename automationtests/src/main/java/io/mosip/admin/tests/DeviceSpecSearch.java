...
public class DeviceSpecSearch  extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(DeviceSpecSearch.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, DeviceSpecSearch.testCaseName);
		} catch (Exception e) {
