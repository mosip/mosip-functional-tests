...
public class UpdateDeviceSpecification  extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(query, "masterdata"))
			...
			logger.info("not able to update Device Specification using query from query.properties");
	}
	...
	public void updateDeviceSpecification(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUpdateDeviceSpecificationPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteUpdatedDeviceSpecification").toString(), "masterdata"))
			...
			logger.info("not able to delete updated Device Specification details using query from query.properties");
			throw new AdminTestException("not able to delete updated Device Specification details data form DB");
		}
	}
}
