...
public class DeviceValidate extends AdminTestUtil implements ITest {
	...
	private static final Logger logger = Logger.getLogger(DeviceValidate.class);
	...
	public void deviceValidate(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
