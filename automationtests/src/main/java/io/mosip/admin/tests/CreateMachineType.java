...
public class CreateMachineType  extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		String query = queries.get("createMachineType").toString();
		if (masterDB.executeQuery(query, "masterdata"))
			logger.info("Machine Type created with new code as Test successfully using query from query.properties");
		else
			logger.info("not able to create Machine Type using query from query.properties");
	}
	...
	public void createMachineType(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getCreateMachineTypePath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteMachineType").toString(), "masterdata"))
			logger.info("deleted all created Machine Type details successfully");
		else {
			logger.info("not able to delete created Machine Type details using query from query.properties");
			throw new AdminTestException("not able to delete created Machine Type details data form DB");
		}
	}
}