...
public class UnmapUserRegistrationCenter extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(UnmapUserRegistrationCenter.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(queries.get("createRegCenterWithDifferentData").toString(), "masterdata")
				...
				&& masterDB.executeQuery(queries.get("mapUserRegCenter").toString(), "masterdata"))
	...
	public void unmapUserRegistrationCenter(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException, IOException, ParseException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUnmapUserRegistrationCenterPath();
	...
	public void cleanup() throws AdminTestException {
		...
		String query4 = queries.get("deleteMapUserRegCenter").toString();
		if (masterDB.executeQuery(query4, "masterdata") && masterDB.executeQuery(query3, "masterdata") 
				&& masterDB.executeQuery(query2, "masterdata")
				&& masterDB.executeQuery(query1, "masterdata"))
