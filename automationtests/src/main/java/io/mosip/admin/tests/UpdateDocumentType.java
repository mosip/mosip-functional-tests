...
public class UpdateDocumentType extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(UpdateDocumentType.class);
	...
	public void setTestType() {
		...
		String query = queries.get("createDocumentType").toString().replace(";", queries.get("updateDocumentType").toString());
	...
	public void createDocType(TestParameters objTestParameters, String testScenario, String testcaseName)
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl()
				+ RunConfigUtil.objRunConfig.getUpdateDocumentTypePath();
...
adminCookie = (cookieChanged) ? kernelAuthLib.getAuthForAdmin():adminCookie;
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteDocumentType").toString(), "masterdata"))
