...
public class SearchBlackListedWords extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(SearchBlackListedWords.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, SearchBlackListedWords.testCaseName);
		} catch (Exception e) {
	...
	public void searchBlackListedWords(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getSearchBlackListedWords();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		String cookieValue = getAuthorizationCookie(getCookieRequestFilePathForUinGenerator(),"https://"+System.getProperty("env.user")+".mosip.io/r2/v1/authmanager/authenticate/useridPwd",AUTHORIZATHION_COOKIENAME);
