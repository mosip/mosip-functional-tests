...
public class GetZoneHierarchy  extends AdminTestUtil implements ITest {
	...
	public void getZoneHierarchy(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getSetZoneHierarchy();
