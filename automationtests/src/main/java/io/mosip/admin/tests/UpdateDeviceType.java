...
public class UpdateDeviceType  extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		String query = queries.get("updateDeviceType").toString();
		if (masterDB.executeQuery(query, "masterdata"))
			logger.info("Device Type updated with new code as Test successfully using query from query.properties");
		else
			logger.info("not able to update Device Type using query from query.properties");
	}
	...
	public void updateDeviceType(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUpdateDeviceTypePath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteUpdatedDeviceType").toString(), "masterdata"))
			logger.info("deleted all update Device Type details successfully");
		else {
			logger.info("not able to delete update Device Type details using query from query.properties");
			throw new AdminTestException("not able to delete update Device Type details data form DB");
		}
	}
}