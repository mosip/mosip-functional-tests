...
public class UpdateDeviceStatus extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(UpdateDeviceStatus.class);
	...
	public void updateDeviceStatus(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUpdateDeviceStatusPath();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		putRequestWithQueryParmAndGenerateOuputFileWithCookie(testCaseName.listFiles(), url, "request", "output-1-actual-response", 200, AUTHORIZATHION_COOKIENAME, adminCookie);
