...
public class GetZoneNameBasedOnUserIDAndLangCode extends AdminTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(GetZoneNameBasedOnUserIDAndLangCode.class);
	...
	public void getZoneName(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() +  RunConfigUtil.objRunConfig.getSetGetZoneNameBasedOnUserIDAndLangCode();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		getRequestWithQueryAndGenerateOuputFileWithCookie(testCaseName.listFiles(), url, "request", "output-1-actual-response",
