...
public class CreateDeviceSpecification  extends AdminTestUtil implements ITest {
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(query, "masterdata"))
			...
			logger.info("not able to create Device Specification using query from query.properties");
	}
	...
	public void createDeviceSpecification(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getCreateDeviceSpecificationPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(queries.get("deleteCreatedDeviceSpecification").toString(), "masterdata"))
			...
			logger.info("not able to delete created Device Specification details using query from query.properties");
			throw new AdminTestException("not able to delete created Device Specification details data form DB");
		}
	}
}
