...
import io.mosip.admin.tests.FetchHolidayLocation;
...
public class FetchGenderType extends KernelTestUtil implements ITest {

	private static final Logger logger = Logger.getLogger(FetchHolidayLocation.class);
	...
	public void setConfigurations(String testType) {
		RunConfigUtil.getRunConfigObject("kernel");
		RunConfigUtil.objRunConfig.setConfig(this.TESTDATA_PATH, this.TESTDATA_FILENAME, testType);
		TestDataProcessor.initateTestDataProcess(this.TESTDATA_FILENAME, this.TESTDATA_PATH, "kernel");
	}
	...
	public void fetchHolidayLoc(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url="https://dev.mosip.net" + RunConfigUtil.objRunConfig.getFetchGenderTypePath();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		getRequestAndGenerateOuputFileWithCookie(testCaseName.listFiles(), url, "request", "output-1-actual-response", 200, AUTHORIZATHION_COOKIENAME, adminCookie);
