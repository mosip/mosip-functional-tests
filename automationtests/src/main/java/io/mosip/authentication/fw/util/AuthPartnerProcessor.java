		...
		try {
			authPartherProcessor = Runtime.getRuntime()
					.exec(new String[] { getJavaPath(), "-Dmosip.base.url="+ApplnURI,
							"-Dserver.port="+encryptUtilPort, "-Dauth-token-generator.rest.clientId="+"mosip-resident-client", "-Dauth-token-generator.rest.secretKey="+"1eJ1L6QXTp5PhLNv", "-Dauth-token-generator.rest.appId="+"resident", "-jar", getDemoAppJarPath() });
