 ...
 *
 */
public class InternalOtpAuthentication extends PrerequisteTests implements ITest {

	private static final Logger logger = Logger.getLogger(InternalOtpAuthentication.class);
	...
	public void setResultTestName(ITestResult result) {
		try {
			...
			f.set(baseTestMethod, InternalOtpAuthentication.testCaseName);
			if(!result.isSuccess())
	...
	public void idaOtpAuthenticationTest(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException {
		...
		Map<String, String> tempEncryptMap = getInternalEncryptKeyvalue(testCaseName.listFiles(), "identity-encrypt");
