 ...
 *
 */
public class InternalOtpGeneration extends PrerequisteTests implements ITest {

	private static final Logger logger = Logger.getLogger(InternalOtpGeneration.class);
