				...
				session.doWork(new Work() {
					...
					public void execute(Connection connection) throws SQLException {
						...
						try {
							...
							statement
									.addBatch("delete from master.registration_center where cr_by='masterdata-220005'");
							statement.addBatch("delete from master.loc_holiday where cr_by='masterdata-220005'");
							statement.addBatch("delete from master.reg_center_type where cr_by='masterdata-220005'");
							statement
									.addBatch("delete from master.registration_center where cr_by='masterdata-220005'");
							...
							statement
									.addBatch("delete from master.biometric_attribute where cr_by='masterdata-220005'");
