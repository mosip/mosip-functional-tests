package io.mosip.registration.reporting;
...
public class CustomTestNGReporter extends Reporter implements IReporter {
	...
	private static final String emailableReportTemplateFile = new File(
			"./src/main/resources/customize-emailable-report-template.html").getAbsolutePath();
	...
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
		try {
			...
			File targetFile = new File(outputDirectory + "/MOSIP_RegistrationClientAutoRun_TestNGReport.html");
