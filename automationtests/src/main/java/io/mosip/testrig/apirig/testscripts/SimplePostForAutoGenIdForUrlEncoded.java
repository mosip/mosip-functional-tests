	...
	public void test(TestCaseDTO testCaseDTO)
		...
		if (testCaseDTO.getTemplateFields() != null && templateFields.length > 0) {
			...
			if (testCaseName.contains("ESignet_")) {
				...
				if (testCaseDTO.getEndPoint().contains("$GETENDPOINTFROMWELLKNOWN$") && BaseTestCase.currentModule.equalsIgnoreCase("resident")) {
					endPoint = getValueFromEsignetWellKnownEndPoint("token_endpoint");
				}
				response = postWithBodyAndCookieForAutoGeneratedIdForUrlEncoded(endPoint,
