...
public class PacketManagerMetaInfo extends BaseTestCase implements ITest{

	private static Logger logger = Logger.getLogger(PacketManagerDocument.class);
	...
	static String folderPath = "regProc/PacketManagerMetaInfo";
	static String outputFile = "PacketManagerMetaInfoOutput.json";
	static String requestKeyFile = "PacketManagerMetaInfoRequest.json";
	String validToken = "";
	...
	public void healthCheck() throws Exception {
		...
		try {
			...
			Boolean status = healthCheckUtil.healthCheck(properties.getProperty("packetManagerMetaInfoApi"));
			if (status) {
				Assert.assertTrue(true);
				
				PacketUtil packetUtil = new PacketUtil();
				String existing_packet_path = parentDir + new_packet_path;
				String metaInfo_smoke = parentDir + folderPath + File.separator + "Valid_smoke";
				packetUtil.editPacketManagerRequestResponse(existing_packet_path, metaInfo_smoke);
				String metaInfo_smoke_cacheFalse = parentDir + folderPath + File.separator
						+ "Valid_smoke_byPassCacheFalse";
				packetUtil.editPacketManagerRequestResponse(existing_packet_path,
						metaInfo_smoke_cacheFalse);
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "packetManagerMetaInfo")
	...
	@Test(dataProvider = "packetManagerMetaInfo")
	public void packetManagerMetaInfo(String testSuite, Integer i, JSONObject object) {
		
		String testcase = (String) object.get("testCaseName");
		String metaInfoApi = prop.getProperty("packetManagerMetaInfoApi");
		...
		Response actualResponse = apiRequests.postRequestWithRequestResponseHeaders(metaInfoApi, actualRequest,
	...
	public void setResultTestName(ITestResult result) {
		...
		try {
			...
			f.set(baseTestMethod, PacketManagerMetaInfo.testCaseName);
