...
public class PacketManagerSearchField extends BaseTestCase implements ITest{
	...
	static String folderPath = "regProc/PacketManagerSearchField";
	static String outputFile = "PacketManagerSearchFieldOutput.json";
	static String requestKeyFile = "PacketManagerSearchFieldRequest.json";
	String validToken = "";
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "packetManagerSearchField")
	...
	public void packetManagerSearchField(String testSuite, Integer i, JSONObject object) {
		...
		String searchFieldApi = prop.getProperty("packetManagerSearchApi");
	...
	public void setResultTestName(ITestResult result) {
		...
		try {
			...
			f.set(baseTestMethod, PacketManagerSearchField.testCaseName);
