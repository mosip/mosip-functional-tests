...
public class PacketManagerDocument extends BaseTestCase implements ITest{
	...
	static String folderPath = "regProc/PacketManagerDocument";
	static String outputFile = "PacketManagerDocumentOutput.json";
	static String requestKeyFile = "PacketManagerDocumentRequest.json";
	String validToken = "";
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "packetManagerDocument")
	...
	@Test(dataProvider = "packetManagerDocument")
	public void packetManagerDocument(String testSuite, Integer i, JSONObject object) {
		String testcase = (String) object.get("testCaseName");
		String documentApi = prop.getProperty("packetManagerDocumentApi");
		...
		Response actualResponse = apiRequests.postRequestWithRequestResponseHeaders(documentApi, actualRequest,
		...
		if (testcase.contains("smoke")) {
			Object responseDocument = actualResponse.jsonPath().get("response.document");
	...
	public void setResultTestName(ITestResult result) {
		...
		try {
			...
			f.set(baseTestMethod, PacketManagerDocument.testCaseName);
