...
public class SecurityTests extends BaseTestCase implements ITest {
	...
	public void getValidPacketPath() {
		...
		try {
			...
			FileReader reader = new FileReader(
					new File(apiRequests.getResourcePath() + "config/folderPaths.properties"));
	...
	public void syncRequestWithValidToken() {
		...
		Response response = apiRequests.regProcSyncRequest(api.getProperty("syncListApi"), encryptedData,
				centre_machine_refId, timeStamp.toString() + "Z", MediaType.APPLICATION_JSON, validToken);
	...
	public void syncRequestWithInvalidToken() {
		...
		Response response = apiRequests.regProcSyncRequest(api.getProperty("syncListApi"), encryptedData,
				centre_machine_refId, timeStamp.toString() + "Z", MediaType.APPLICATION_JSON, validToken + "ABC");
	...
	public void packetUploadWithInValidToken() {
		Response res = apiRequests.regProcPacketUpload(packet, api.getProperty("packetReceiverApi"),
				validToken + "ABC");
