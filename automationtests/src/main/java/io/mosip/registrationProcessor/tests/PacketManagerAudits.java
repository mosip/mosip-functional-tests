...
public class PacketManagerAudits extends BaseTestCase implements ITest {

	private boolean status = false;
	private static Logger logger = Logger.getLogger(PacketManagerAudits.class);
	protected static String testCaseName = "";
	static String moduleName = "RegProc";
	RegProcTokenGenerate tokenGenerate = new RegProcTokenGenerate();
	String token = "";
	Properties prop = new Properties();
	RegProcApiRequests apiRequests = new RegProcApiRequests();
	JSONObject expectedResponse = null;
	static String folderPath = "regProc/PacketManagerAudits";
	static String outputFile = "PacketManagerAuditsOutput.json";
	static String requestKeyFile = "PacketManagerAuditsRequest.json";
	String validToken = "";
	...
	public void getTestCaseName(Method method, Object[] testdata, ITestContext ctx) {
		...
		String apiName = "packetManagerAudits";
	 ...
	 * @throws Exception
	 */
	@DataProvider(name = "packetManagerAudits")
	...
	@Test(dataProvider = "packetManagerAudits")
	public void packetManagerAudits(String testSuite, Integer i, JSONObject object) {
		...
		String auditUrlPath = prop.getProperty("packetManagerAuditsApi");
		try {
			expectedResponse = ResponseRequestMapper.mapResponse(testSuite, object);
		} catch (IOException | ParseException e1) {
			e1.printStackTrace();
		}
		Response actualResponse = apiRequests.postRequestWithRequestResponseHeaders(auditUrlPath, actualRequest,
	...
	public void setResultTestName(ITestResult result) {
		...
		try {
			...
			f.set(baseTestMethod, PacketManagerAudits.testCaseName);
