...
public class SaveSecureBiometricInterface extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SaveSecureBiometricInterface.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms")
			...
			logger.info("SaveSecureBiometricInterface with id as Test successfully");
		else
			logger.info("not able to SaveSecureBiometricInterface");
	}
	...
	public void saveSecureBiometricInterface(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getSaveSecureBiometricInterfacePath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteSecureBiometricInterfaceH").toString(), "regdevice")
			...
			logger.info("deleted all SaveSecureBiometricInterface data successfully");
		else {
			logger.info("not able to delete SaveSecureBiometricInterface data");
		}
		logger.info("END");
		}
}
