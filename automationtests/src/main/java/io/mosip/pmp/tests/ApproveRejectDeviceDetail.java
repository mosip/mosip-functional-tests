...
public class ApproveRejectDeviceDetail extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(ApproveRejectDeviceDetail.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms")
			...
			logger.info("ApproveRejectDeviceDetail Test successfully using query from partnerQueries.properties");
		else
			logger.info("not able to ApproveRejectDeviceDetail using query from partnerQueries.properties");
	}
	...
	public void submitPartnerApiKeyReq(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getApproveRejectDeviceDetailPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteDeviceDetail").toString(), "regdevice")
			...
			logger.info("deleted all ApproveRejectDeviceDetail data successfully");
		else {
			logger.info("not able to delete ApproveRejectDeviceDetail data using query from query.properties");
		}
		logger.info("END");
		}
}
