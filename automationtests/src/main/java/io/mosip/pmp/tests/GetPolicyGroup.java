...
public class GetPolicyGroup extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(GetPolicyGroup.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms"))
			logger.info("GetPolicyGroup with id as Test successfully");
		else
			logger.info("not able to GetPolicyGroup using query");
	}
	...
	public void getPolicyGroup(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getGetPolicyGroupPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deletePolicyGroup").toString(), "pms"))
			logger.info("delete all GetPolicyGroup data successfully");
		else {
			logger.info("not able to delete GetPolicyGroup data");
		}
		logger.info("END");
	}
}
