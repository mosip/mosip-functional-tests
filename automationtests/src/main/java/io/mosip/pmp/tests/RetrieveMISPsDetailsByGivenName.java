...
public class RetrieveMISPsDetailsByGivenName extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(RetrieveMISPsDetailsByGivenName.class);
	...
	public void retrievePartner(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getRetrieveMISPsDetailsByGivenNamePath();
