...
public class UpdateMispStatusByMispId extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(UpdateMispStatusByMispId.class);
	...
	public void submitPartnerApiKeyReq(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUpdateMispStatusByMispIdPath();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		patchUpdateMispStatusByMispId(testCaseName.listFiles(), url, "request", "output-1-actual-response", 0, AUTHORIZATHION_COOKIENAME, partnerCookie);
