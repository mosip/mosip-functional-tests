...
public class GetPolicyAgainstApiKey extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(GetPolicyAgainstApiKey.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms") &&
			...
			logger.info("not able to GetPolicyAgainstApiKey using query");
	}
	...
	public void getPolicyGroup(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getGetPolicyAgainstApiKeyPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deletePartnerApiKeyData").toString(), "pms") &&
			...
			logger.info("not able to delete GetPolicyAgainstApiKey data");
		}
		logger.info("END");
	}
}
