...
public class UpdateExistingPolicyForPolicyGroup extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(UpdateExistingPolicyForPolicyGroup.class);
