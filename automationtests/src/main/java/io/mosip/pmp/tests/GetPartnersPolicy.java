...
public class GetPartnersPolicy extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(GetPartnersPolicy.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms") &&
			...
			logger.info("GetPartnersPolicy with id as Test successfully");
		else
			logger.info("not able to GetPartnersPolicy using query");
	}
	...
	public void getPolicyGroup(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getGetPartnersPolicyPath();
	...
	public void cleanup() throws AdminTestException {
		if (
				//masterDB.executeQuery(partnerQueries.get("deletePartnerApiKeyData").toString(), "pms") &&
			...
			logger.info("delete all GetPartnersPolicy data successfully");
		else {
			logger.info("not able to delete GetPartnersPolicy data");
		}
		logger.info("END");
	}
}
