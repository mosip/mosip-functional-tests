...
public class CreatePolicyGroup extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(CreatePolicyGroup.class);
	...
	public void registerPartner(TestParameters objTestParameters, String testScenario, String testcaseName)
		...
		String url = RunConfigUtil.objRunConfig.getAdminEndPointUrl()
				+ RunConfigUtil.objRunConfig.getCreatePolicyGroupPath();
