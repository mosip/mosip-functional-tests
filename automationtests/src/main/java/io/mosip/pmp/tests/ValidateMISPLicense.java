...
public class ValidateMISPLicense extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(ValidateMISPLicense.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createMISIPQuery, "pmp") 
			...
			logger.info("ValidateMISPLicense Test successfully using query from partnerQueries.properties");
		else
			logger.info("not able to ValidateMISPLicense using query from partnerQueries.properties");
	...
	public void validateMISPLicense(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getValidateMISPLicensePath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteValidateMISPLicence").toString(), "pmp")
			...
			logger.info("deleted all ValidateMISPLicense data successfully");
		else {
			logger.info("not able to delete ValidateMISPLicense data using query from query.properties");
		}
		logger.info("END");
	}
}
