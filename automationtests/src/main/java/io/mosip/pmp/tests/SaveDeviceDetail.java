...
public class SaveDeviceDetail extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SaveDeviceDetail.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms")
			...
			logger.info("SaveDeviceDetail with id as Test successfully");
		else
			logger.info("not able to SaveDeviceDetail");
	}
	...
	public void saveDeviceDetail(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getSaveDeviceDetailPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteDeviceDetail").toString(), "regdevice")
			...
			logger.info("deleted all SaveDeviceDetail data successfully");
		else {
			logger.info("not able to delete SaveDeviceDetail data");
		}
		logger.info("END");
		}
}
