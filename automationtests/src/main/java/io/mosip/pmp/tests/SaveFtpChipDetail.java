...
public class SaveFtpChipDetail extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SaveFtpChipDetail.class);
	...
	public void setTestType() {
		...
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms")
			...
			logger.info("SaveFtpChipDetail with id as Test successfully");
		else
			logger.info("not able to SaveFtpChipDetail");
	}
	...
	public void saveFtpChipDetail(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getSaveFtpChipDetailPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteSaveFtpChipDetail").toString(), "regdevice")
			...
			logger.info("deleted all SaveFtpChipDetail data successfully");
		else {
			logger.info("not able to delete SaveFtpChipDetail data");
		}
		logger.info("END");
		}
}
