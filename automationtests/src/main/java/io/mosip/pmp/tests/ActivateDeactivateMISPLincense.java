...
public class ActivateDeactivateMISPLincense extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(ActivateDeactivateMISPLincense.class);
	...
	public void ActivateDeactiveMISPLicense(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getActivateMISPLicense();
		...
		putActivateDeactivateMISPLincense(testCaseName.listFiles(), url, "request", "output-1-actual-response", 0, AUTHORIZATHION_COOKIENAME, partnerCookie);
