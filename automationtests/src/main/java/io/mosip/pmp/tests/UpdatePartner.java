...
public class UpdatePartner extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(UpdatePartner.class);
	...
	public void updatePartner(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getUpdatePartnerPath();
		logger.info("******Post request Json to EndPointUrl: " + url+
				 " *******");
		putRequestWithBodyAndParameter(testCaseName.listFiles(), url, "request", "output-1-actual-response", 0, AUTHORIZATHION_COOKIENAME, partnerCookie);
