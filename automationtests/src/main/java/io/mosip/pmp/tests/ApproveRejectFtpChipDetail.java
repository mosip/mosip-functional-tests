...
public class ApproveRejectFtpChipDetail extends PartnerTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(ApproveRejectFtpChipDetail.class);
	...
	public void setTestType() {
		...
		String createSaveFtpChipDetailQuery = partnerQueries.get("createSaveFtpChipDetail").toString();
		if (masterDB.executeQuery(createPolicyGroupQuery, "pms")
				...
				&& masterDB.executeQuery(createSaveFtpChipDetailQuery, "regdevice"))
			logger.info("ApproveRejectFtpChipDetail Test successfully using query from partnerQueries.properties");
		else
			logger.info("not able to ApproveRejectFtpChipDetail using query from partnerQueries.properties");
	}
	...
	public void approveRejectFtpChipDetail(TestParameters objTestParameters, String testScenario, String testcaseName) throws AuthenticationTestException, AdminTestException {
		...
		String url=RunConfigUtil.objRunConfig.getAdminEndPointUrl() + RunConfigUtil.objRunConfig.getApproveRejectFtpChipDetailPath();
	...
	public void cleanup() throws AdminTestException {
		if (masterDB.executeQuery(partnerQueries.get("deleteSaveFtpChipDetail").toString(), "regdevice")
			...
			logger.info("deleted all ApproveRejectFtpChipDetail data successfully");
		else {
			logger.info("not able to delete ApproveRejectFtpChipDetail data using query from query.properties");
		}
		logger.info("END");
		}
}
