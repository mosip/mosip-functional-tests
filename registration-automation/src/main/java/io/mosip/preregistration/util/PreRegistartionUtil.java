...
public class PreRegistartionUtil {
	...
	public Response FetchCentre(String authToken) {
		...
		String preRegFetchCenterIDURI = preReg_FetchCenterIDURI + "10003";
	...
	public Map<String, String> getProperty() {
		try {
			FileInputStream fi=new FileInputStream(new File(CommonUtil.getResourcePath()+"/preReg/config/preRegApi.properties"));
			prop.load(fi);
			fi.close();
