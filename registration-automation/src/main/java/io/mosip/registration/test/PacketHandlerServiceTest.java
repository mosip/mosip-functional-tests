...
public class PacketHandlerServiceTest extends BaseConfiguration implements ITest {
	...
	public void validatePacketCreation(String testCaseName, JSONObject object) throws ParseException {
...
/*				String filePath = String
				...
				File packetToBeUploaded=new File(packetStore.getParent()+"/PacketStore/".concat(formatDate(new Date(), String.valueOf(ApplicationContext.map().get(RegistrationConstants.PACKET_STORE_DATE_FORMAT)))).concat(seperator).concat(packetResponse.get("RANDOMID"))+ RegistrationConstants.ZIP_FILE_EXTENSION);
