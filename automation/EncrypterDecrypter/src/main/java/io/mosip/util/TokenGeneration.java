...
import io.moisp.Dto.TokenGenerationDto;
import io.mosip.entity.TokenGenerationEntity;
import io.restassured.response.Response;

public class TokenGeneration {
	String authmangerUrl="";
...
public String getToken(TokenGenerationEntity tokenGenerateEntity) {
	...
	Response response=applnMethods.postRequest(authmangerUrl,requestToBeSent,MediaType.APPLICATION_JSON,MediaType.APPLICATION_JSON);
...
public String readPropertyFile(String tokenGenerationFilePath) {
	...
	authmangerUrl=prop.getProperty("authmangerUrl");
