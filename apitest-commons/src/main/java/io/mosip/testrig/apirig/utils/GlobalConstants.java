...
public class GlobalConstants {
	...
	public static final String ERROR_STRING_4 = "Request doesn't contain autogenerated field: ";
	public static final String ERROR_STRING_5 = "Saved Request Field: ";
	public static final String WRITE_STRING = " to write- Response : ";
	public static final String WRITE_STRING_1 = " to write- Request : ";
	...
	public static final String PARTNER_MANAGEMENT_SERVICE = "pms";
	...
	public static final String ESIGNET_BASE_URL = ConfigManager.getEsignetBaseUrl();

	public static final String ESIGNET_ACTUATOR_URL = ESIGNET_BASE_URL
			+ ConfigManager.getproperty(ESIGNET_ACTUATOR_ENDPOINT_KEYWORD);
