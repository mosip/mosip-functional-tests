...
public class PartnerRegistration extends AdminTestUtil {
	...
	public static String organizationName = BaseTestCase.currentModule + "_pid";
	public static String ekycOrganizationName = BaseTestCase.currentModule + "_ekyc_pid";
	public static String deviceOrganizationName = BaseTestCase.currentModule + "_device_pid";
	public static String ftmOrganizationName = BaseTestCase.currentModule + "_ftm_pid";
