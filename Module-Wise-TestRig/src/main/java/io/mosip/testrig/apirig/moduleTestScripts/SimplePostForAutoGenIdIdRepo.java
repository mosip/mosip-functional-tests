...
public class SimplePostForAutoGenIdIdRepo extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(SimplePostForAutoGenIdIdRepo.class);
