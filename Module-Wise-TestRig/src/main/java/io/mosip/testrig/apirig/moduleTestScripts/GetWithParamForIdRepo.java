...
public class GetWithParamForIdRepo extends AdminTestUtil implements ITest {
	private static final Logger logger = Logger.getLogger(GetWithParamForIdRepo.class);
